"""
Live Demo: Agno-Powered Agent Squad
...
async def demo():
    ...
    try:
        ...
        input("\n⏸️  Press Enter to continue to Scene 2...")
        ...
        input("\n⏸️  Press Enter to continue to Scene 3...")
        ...
        print(f"   Complexity: {tl_review['complexity_score']}/10")
        print(f"   Technical Risks: {len(tl_review['technical_risks'])}")

        input("\n⏸️  Press Enter to continue to Scene 4...")
        ...
        print(f"\n📝 Breakdown Details:\n{breakdown['breakdown_notes'][:600]}...")

        input("\n⏸️  Press Enter to continue to Scene 5...")
        ...
        analysis = await backend_dev.analyze_task(
            task=subtask,
            context={"project": "Agent Squad Dashboard"}
        )

        print(f"\n💭 Backend Developer's Analysis:")
        print(f"{analysis.content[:600]}...")
        ...
        print(f"\n💡 Try it yourself:")
        print(f"   - Use same session_id to resume conversations")
        print(f"   - Agents remember everything from previous interactions")
        print(f"   - Works across different agent instances")
